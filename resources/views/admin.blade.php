...
<!------------------------------------------------------------------------------------------------------------->
  ...
  <div class="content-wrapper" style="margin-right: 250px; margin-left: 0px";>
    <!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">الارشفه</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                ...
                <a href=# class="btn btn-outline-light me-2"> انوار الكتب </a>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                ...
                <a href="{{ route('books.index') }}" class="btn btn-outline-light me-2"> جميع الكتب </a>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                ...
                <a href="#" class="btn btn-outline-light me-2">اضافة المستخدمين  </a>
          ...
          <div class="col-lg-3 col-6" >
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                <h3>65</h3>
                <a href="{{ route('books.create') }}" class="btn btn-outline-light me-2">اضافة كتب </a>
